...
fun RecyclerView.ViewHolder.getString(resId: Int): String =
        this.itemView.context.getString(resId)
 ...
 * */
fun RecyclerView.ViewHolder.getFormattedString(resId: Int, vararg args: Any?): String =
 ...
 * @param args arguments to format the string with.
 * */
fun RecyclerView.ViewHolder.getPluralString(resId: Int, quantity: Int, vararg args: Any?): String =
        this.itemView.resources.getQuantityString(resId, quantity, *args)
